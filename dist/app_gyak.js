...
// Project Type
var ProjectStatus_;
(function (ProjectStatus_) {
    ProjectStatus_[ProjectStatus_["Active"] = 0] = "Active";
    ProjectStatus_[ProjectStatus_["Finished"] = 1] = "Finished";
})(ProjectStatus_ || (ProjectStatus_ = {}));
class Project {
...
class ProjectState_ extends State {
    constructor() {
        super();
        this.projects = [];
    }
    static getInstance() {
        ...
        this.instance_ = new ProjectState_();
        return this.instance;
    }
